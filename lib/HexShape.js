...
var HexShape = function (_React$Component) {
  ...
  _createClass(HexShape, [{
    ...
    value: function getStyles(hex) {
      return !hex.image ? {} : { fill: 'url(#' + _HexUtils2.default.getID(hex) + ')' };
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var hex = this.props.hex;
      var text = hex.text || _HexUtils2.default.getID(hex);
      var actions = this.props.actions;
      var styles = this.getStyles(hex);
      var points = this.getPoints(hex);
      var className = hex.className ? 'shape-group ' + hex.className : 'shape-group';

      return _react2.default.createElement(
        'g',
        { className: className, transform: this.translate(), draggable: 'true',
          onMouseEnter: function onMouseEnter(e) {
            return actions.onMouseEnter && actions.onMouseEnter(_this2.props.hex, e);
          },
          onMouseLeave: function onMouseLeave(e) {
            return actions.onMouseLeave && actions.onMouseLeave(_this2.props.hex, e);
          },
          onDragStart: function onDragStart(e) {
            return actions.onDragStart && actions.onDragStart(_this2.props.hex, e);
          },
          onDragEnd: function onDragEnd(e) {
            return actions.onDragEnd && actions.onDragEnd(_this2.props.hex, e);
          },
          onDragOver: function onDragOver(e) {
            return actions.onDragOver && actions.onDragOver(_this2.props.hex, e);
          },
          onDrop: function onDrop(e) {
            return actions.onDrop && actions.onDrop(_this2.props.hex, e);
          },
          onClick: function onClick(e) {
            return actions.onClick && actions.onClick(_this2.props.hex, e);
          }
        },
